...
class HFBertEncoder(BertModel):
    ...
    def forward(
        ...
        if self.config.output_hidden_states:
            ...
            hidden_states = None
            #print("Calling this stuff")
            sequence_output, pooled_output = super().forward(input_ids=input_ids, token_type_ids=token_type_ids, attention_mask=attention_mask)
        #print("SEQ: ",sequence_output)
        #print("Type of sequence output: ",type(sequence_output))
